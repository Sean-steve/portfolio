...
function elisc_tm_modalbox() {
  ...
  jQuery(".elisc_tm_all_wrap").prepend(
    '<div class="elisc_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="fa fa-times" aria-hidden="true"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
